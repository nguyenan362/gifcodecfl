...
interactive_install() {
  ...
  # 1. Kiem tra/cai dat cac bien moi truong he thong can thiet
  load_profile_file
  ensure_profile_vars
  load_profile_file
  ensure_app_user
  ...
  # 4. Build app va setup chay native systemd
  build_app
  install_systemd_units
  enable_core_services
  enable_tunnel_service_if_configured
